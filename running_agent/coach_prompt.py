...
SAVE_WEEKLY_PLAN_TOOL = {
    ...
    "description": (
        ...
        "plan, such as 'what might next week look like?' or 'suggest a plan'. Convert saved "
...
COACHING_INSTRUCTIONS = (
    ...
    "or a request for your suggestion. Rewrite natural plan text into a complete plain-text "
    "weekly plan with one line per planned day, preserving runner shorthand. If the athlete asks "
    "for a suggested, possible, hypothetical, or example plan, do not save it unless they later "
    "explicitly approve it as the actual plan. After saving the plan, briefly acknowledge it in "
