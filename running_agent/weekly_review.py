...
def weekly_coaching_message(
    ...
    prompt = (
        ...
        "For a return after injury or a break, return-from-injury guidance overrides the "
        "percentage cap and the requirement for a full daily plan. Ask for the current return "
        "baseline and symptom response if missing rather than inventing daily mileage. "
